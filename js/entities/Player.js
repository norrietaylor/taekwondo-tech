...
class Player {
    ...
    updateWings() {
        ...
        if (currentOutfit === 'grimlock' || currentOutfit === 'bumblebee' || currentOutfit === 'hotrod' || currentOutfit === 'elita' || currentOutfit === 'portalbot' || !costume.hasWings) {
            this.leftWing.setVisible(false);
            this.rightWing.setVisible(false);
            return;
        }
    ...
    shootDragonProjectile() {
        ...
        this.fireballs.push({
            ...
            traveled: 0,
            maxDistance: costume.projectileType === 'portal' ? 400 : (this.scene.levelWidth || 3000),
