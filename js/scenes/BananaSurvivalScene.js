...
class BananaSurvivalScene extends Phaser.Scene {
  ...
  createBackground() {
    ...
    // Title banner
    this.add
      .text(this.levelWidth / 2, 30, '🍌 BANANA SURVIVAL MODE 🍌', {
        fontSize: '28px',
        fill: '#FFE135',
        fontWeight: 'bold',
        stroke: '#8B4513',
  ...
  showWaveIndicator() {
    const waveText = this.add
      .text(this.levelWidth / 2, this.levelHeight / 2 - 50, `WAVE ${this.wave}`, {
        fontSize: '48px',
        fill: '#FFE135',
        fontWeight: 'bold',
        stroke: '#8B4513',
  ...
  createUI() {
    ...
    // Slips remaining
    this.slipsText = this.add
      .text(20, 100, `Slips: 0/${this.maxSlips}`, {
        fontSize: '20px',
        fill: '#FFE135',
        backgroundColor: '#000000',
        padding: { x: 10, y: 5 },
    ...
    // Bananas deflected
    this.deflectedText = this.add
      .text(20, 140, 'Deflected: 0', {
        fontSize: '18px',
        fill: '#00FF00',
        backgroundColor: '#000000',
        padding: { x: 10, y: 5 },
    ...
    this.waveText = this.add
      .text(this.levelWidth - 20, 60, 'Wave: 1', {
        fontSize: '20px',
        fill: '#FF6B35',
        backgroundColor: '#000000',
        padding: { x: 10, y: 5 },
  ...
  showMessage(text, color = 0xffffff) {
    const message = this.add
      .text(this.levelWidth / 2, this.levelHeight / 2, text, {
        fontSize: '32px',
  ...
  showGameOverScreen() {
    ...
    // Title
    this.add
      .text(this.levelWidth / 2, this.levelHeight / 2 - 120, '🍌 GAME OVER 🍌', {
        fontSize: '36px',
        fill: '#FFE135',
        fontWeight: 'bold',
        stroke: '#8B4513',
    ...
    stats.forEach((stat, i) => {
      this.add
        .text(this.levelWidth / 2, this.levelHeight / 2 - 50 + i * 30, stat, {
          fontSize: '18px',
          fill: '#ffffff',
        })
        .setOrigin(0.5)
    ...
    // Calculate score
    const finalScore =
      Math.floor(this.survivalTime) * 10 + this.bananasDeflected * 15 + this.wave * 100;

    this.add
      .text(this.levelWidth / 2, this.levelHeight / 2 + 80, `Final Score: ${finalScore}`, {
        fontSize: '24px',
        fill: '#00FF00',
        fontWeight: 'bold',
      })
    ...
    const retryButton = this.add
      .text(this.levelWidth / 2 - 80, this.levelHeight / 2 + 130, 'Retry', {
        fontSize: '20px',
        fill: '#ffffff',
    ...
    const menuButton = this.add
      .text(this.levelWidth / 2 + 80, this.levelHeight / 2 + 130, 'Menu', {
        fontSize: '20px',
        fill: '#ffffff',
