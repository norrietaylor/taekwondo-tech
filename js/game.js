    ...
    constructor() {
        ...
        this.dragonCostumes = {
            ...
            'omegaPrime': {
                ...
                fireballColors: [0xff2db4, 0x00e5ff, 0x6e27c5, 0xffffff, 0xff66e0, 0x40ddff, 0xb388ff, 0xff2db4],
                fireballCooldown: 5,
                ...
                altPalette: {
                    ...
                    fireballColors: [0xff7a00, 0xffd700, 0xc81212, 0xfff3b0, 0xff5500, 0xffae00, 0xff3300, 0xffd700],
    ...
    checkDragonUnlocks() {
        ...
        if (this.gameData.currentLevel >= 2 && !this.gameData.outfits.unlocked.includes('omegaPrime')) {
            if (this.unlockOutfit('omegaPrime')) {
                ...
                console.log('🐍🐉🤖 OMEGA PRIME UNLOCKED! The ultimate fusion. Press 2 for RED SNAKE form!');
            }
        }
