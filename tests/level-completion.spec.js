...
test.describe.skip('Level Completion Tests', () => {
  ...
  test('Finish line positions should be on platforms for all levels', async ({ page }) => {
    ...
    levelData.forEach((data) => {
      ...
      console.log(
        `Level ${data.level}: Rightmost platform at x=${rightmostPlatform.x}, finish line at x=${data.finishLine.x}`
      );
  ...
  test('Debug level completion manually', async ({ page }) => {
    ...
    const debugInfo = await page.evaluate(() => {
      ...
      return {
        ...
        playerPosition: gameScene.player
          ? { x: gameScene.player.sprite.x, y: gameScene.player.sprite.y }
          : null,
        finishLineExists: !!gameScene.finishLine,
        finishLinePosition: gameScene.finishLine
          ? { x: gameScene.finishLine.x, y: gameScene.finishLine.y }
          : null,
